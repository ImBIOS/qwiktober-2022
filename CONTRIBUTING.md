...
This document contains a set of guidelines which any contributions to ImBIOS/qwiktober-2022 repository must follow.

[If you disagree with something here, you should open up an issue to discuss making a change!](https://github.com/ImBIOS/qwiktober-2022/issues/new)
...
We use a modified version of [GitHub Flow](https://guides.github.com/introduction/flow/) at ImBIOS/qwiktober-2022. The only difference is instead of deploying from a reviewed pull request, we merge first and deploy straight from master.
